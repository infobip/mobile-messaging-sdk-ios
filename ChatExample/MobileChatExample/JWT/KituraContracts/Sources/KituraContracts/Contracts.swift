...
/**
 ...
 router.get("/users") { (id: Int, respondWith: (User?, RequestError?) -> Void) in
     ...
     respondWith(nil, KituraRequestError.notFound)
     ...
 }
 ````
 */
public struct KituraRequestError: RawRepresentable, Equatable, Hashable, Comparable, Error, CustomStringConvertible {
    /**
    ...
    */
    public init<Body: Codable>(_ base: KituraRequestError, body: Body) {
    ...
    response body given as Data and a BodyFormat.
     ...
     - throws: An `UnsupportedBodyFormatError` if the provided `BodyFormat`
             is not supported.
    */
    public init(_ base: KituraRequestError, bodyData: Data, format: BodyFormat) throws {
        self.rawValue = base.rawValue
        self.reason = base.reason
    ...
    */
    public static func < (lhs: KituraRequestError, rhs: KituraRequestError) -> Bool {
...
extension KituraRequestError {
    ...
    */
    public init(httpCode: Int) {
        ...
        self.reason = KituraRequestError.reason(forHTTPCode: httpCode)
    }

    // MARK: Accessing constants representing HTTP status codes
    /// HTTP code 100 - Continue
    public static let `continue` = KituraRequestError(httpCode: 100)
    /// HTTP code 101 - Switching Protocols
    public static let switchingProtocols = KituraRequestError(httpCode: 101)
    /// HTTP code 200 - OK
    public static let ok = KituraRequestError(httpCode: 200)
    /// HTTP code 201 - Created
    public static let created = KituraRequestError(httpCode: 201)
    /// HTTP code 202 - Accepted
    public static let accepted = KituraRequestError(httpCode: 202)
    /// HTTP code 203 - Non Authoritative Information
    public static let nonAuthoritativeInformation = KituraRequestError(httpCode: 203)
    /// HTTP code 204 - No Content
    public static let noContent = KituraRequestError(httpCode: 204)
    /// HTTP code 205 - Reset Content
    public static let resetContent = KituraRequestError(httpCode: 205)
    /// HTTP code 206 - Partial Content
    public static let partialContent = KituraRequestError(httpCode: 206)
    /// HTTP code 207 - Multi Status
    public static let multiStatus = KituraRequestError(httpCode: 207)
    /// HTTP code 208 - Already Reported
    public static let alreadyReported = KituraRequestError(httpCode: 208)
    /// HTTP code 226 - IM Used
    public static let imUsed = KituraRequestError(httpCode: 226)
    /// HTTP code 300 - Multiple Choices
    public static let multipleChoices = KituraRequestError(httpCode: 300)
    /// HTTP code 301 - Moved Permanently
    public static let movedPermanently = KituraRequestError(httpCode: 301)
    /// HTTP code 302 - Found
    public static let found = KituraRequestError(httpCode: 302)
    /// HTTP code 303 - See Other
    public static let seeOther = KituraRequestError(httpCode: 303)
    /// HTTP code 304 - Not Modified
    public static let notModified = KituraRequestError(httpCode: 304)
    /// HTTP code 305 - Use Proxy
    public static let useProxy = KituraRequestError(httpCode: 305)
    /// HTTP code 307 - Temporary Redirect
    public static let temporaryRedirect = KituraRequestError(httpCode: 307)
    /// HTTP code 308 - Permanent Redirect
    public static let permanentRedirect = KituraRequestError(httpCode: 308)
    /// HTTP code 400 - Bad Request
    public static let badRequest = KituraRequestError(httpCode: 400)
    /// HTTP code 401 - Unauthorized
    public static let unauthorized = KituraRequestError(httpCode: 401)
    /// HTTP code 402 - Payment Required
    public static let paymentRequired = KituraRequestError(httpCode: 402)
    /// HTTP code 403 - Forbidden
    public static let forbidden = KituraRequestError(httpCode: 403)
    /// HTTP code 404 - Not Found
    public static let notFound = KituraRequestError(httpCode: 404)
    /// HTTP code 405 - Method Not Allowed
    public static let methodNotAllowed = KituraRequestError(httpCode: 405)
    /// HTTP code 406 - Not Acceptable
    public static let notAcceptable = KituraRequestError(httpCode: 406)
    /// HTTP code 407 - Proxy Authentication Required
    public static let proxyAuthenticationRequired = KituraRequestError(httpCode: 407)
    /// HTTP code 408 - Request Timeout
    public static let requestTimeout = KituraRequestError(httpCode: 408)
    /// HTTP code 409 - Conflict
    public static let conflict = KituraRequestError(httpCode: 409)
    /// HTTP code 410 - Gone
    public static let gone = KituraRequestError(httpCode: 410)
    /// HTTP code 411 - Length Required
    public static let lengthRequired = KituraRequestError(httpCode: 411)
    /// HTTP code 412 - Precondition Failed
    public static let preconditionFailed = KituraRequestError(httpCode: 412)
    /// HTTP code 413 - Payload Too Large
    public static let payloadTooLarge = KituraRequestError(httpCode: 413)
    /// HTTP code 414 - URI Too Long
    public static let uriTooLong = KituraRequestError(httpCode: 414)
    /// HTTP code 415 - Unsupported Media Type
    public static let unsupportedMediaType = KituraRequestError(httpCode: 415)
    /// HTTP code 416 - Range Not Satisfiable
    public static let rangeNotSatisfiable = KituraRequestError(httpCode: 416)
    /// HTTP code 417 - Expectation Failed
    public static let expectationFailed = KituraRequestError(httpCode: 417)
    /// HTTP code 421 - Misdirected Request
    public static let misdirectedRequest = KituraRequestError(httpCode: 421)
    /// HTTP code 422 - Unprocessable Entity
    public static let unprocessableEntity = KituraRequestError(httpCode: 422)
    /// HTTP code 423 - Locked
    public static let locked = KituraRequestError(httpCode: 423)
    /// HTTP code 424 - Failed Dependency
    public static let failedDependency = KituraRequestError(httpCode: 424)
    /// HTTP code 426 - Upgrade Required
    public static let upgradeRequired = KituraRequestError(httpCode: 426)
    /// HTTP code 428 - Precondition Required
    public static let preconditionRequired = KituraRequestError(httpCode: 428)
    /// HTTP code 429 - Too Many Requests
    public static let tooManyRequests = KituraRequestError(httpCode: 429)
    /// HTTP code 431 - Request Header Fields Too Large
    public static let requestHeaderFieldsTooLarge = KituraRequestError(httpCode: 431)
    /// HTTP code 451 - Unavailable For Legal Reasons
    public static let unavailableForLegalReasons = KituraRequestError(httpCode: 451)
    /// HTTP code 500 - Internal Server Error
    public static let internalServerError = KituraRequestError(httpCode: 500)
    /// HTTP code 501 - Not Implemented
    public static let notImplemented = KituraRequestError(httpCode: 501)
    /// HTTP code 502 - Bad Gateway
    public static let badGateway = KituraRequestError(httpCode: 502)
    /// HTTP code 503 - Service Unavailable
    public static let serviceUnavailable = KituraRequestError(httpCode: 503)
    /// HTTP code 504 - Gateway Timeout
    public static let gatewayTimeout = KituraRequestError(httpCode: 504)
    /// HTTP code 505 - HTTP Version Not Supported
    public static let httpVersionNotSupported = KituraRequestError(httpCode: 505)
    /// HTTP code 506 - Variant Also Negotiates
    public static let variantAlsoNegotiates = KituraRequestError(httpCode: 506)
    /// HTTP code 507 - Insufficient Storage
    public static let insufficientStorage = KituraRequestError(httpCode: 507)
    /// HTTP code 508 - Loop Detected
    public static let loopDetected = KituraRequestError(httpCode: 508)
    /// HTTP code 510 - Not Extended
    public static let notExtended = KituraRequestError(httpCode: 510)
    /// HTTP code 511 - Network Authentication Required
    public static let networkAuthenticationRequired = KituraRequestError(httpCode: 511)
...
*/
public protocol KituraOperation: Codable {
...
*/
public struct GreaterThan<I: Identifier>: KituraOperation {
  private var value: I
...
/**
  ...
  Note: The "age=8" format is not an API but an implementation detail that could change in the future.
*/
public struct GreaterThanOrEqual<I: Identifier>: KituraOperation {
  private var value: I
...
/**
  ...
  ```
*/
public struct LowerThan<I: Identifier>: KituraOperation {
  private var value: I
...
/**
  ...
  Note: The "age=8" format is not an API but an implementation detail that could change in the future.
*/
public struct LowerThanOrEqual<I: Identifier>: KituraOperation {
  private var value: I
...
*/
public struct InclusiveRange<I: Identifier>: KituraOperation {
  private var start: I
  private var end: I
...
/**
  ...
  Note: The "age=8,14" format is not an API but an implementation detail that could change in the future.
*/
public struct ExclusiveRange<I: Identifier>: KituraOperation {
  private var start: I
  private var end: I
