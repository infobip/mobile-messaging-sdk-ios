...
public final class MobileMessaging: NSObject, NamedLogger {
    ...
    public class func didRegisterForRemoteNotificationsWithDeviceToken(_ token: Data) {
        ...
        /**
         ...
         6. Run the app.
         */
        InteractiveMessageAlertManager.sharedInstance.showModalNotificationAutomatically(forMessage: MM_MTMessage(
            payload: [
                Consts.APNSPayloadKeys.messageId: "123",
                Consts.APNSPayloadKeys.internalData: [
                    Consts.InternalDataKeys.showInApp: true,
                    Consts.InternalDataKeys.silent: [:],
                    Consts.InternalDataKeys.inAppDetails: [
                        Consts.InAppDetailsKeys.url: "https://www.infobip.com",
                        Consts.InAppDetailsKeys.position: InAppMessagePosition.top.rawValue,
                        Consts.InAppDetailsKeys.type: InAppMessageType.popup.rawValue
                    ]
                ]
            ],
