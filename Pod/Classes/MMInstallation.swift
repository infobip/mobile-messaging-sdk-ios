...
//MARK: - CUSTOM DATA
	...
	/// - parameter completion: The block to execute after the server responded.
	public func save(customData customData: [String: CustomUserDataValue], completion: NSError? -> Void) {
	...
	/// - parameter object: The object for `key`. Pass `object` as either `nil` or `NSNull()` in order to remove the key-value pair on the server.
	/// - parameter completion: The block to execute after the server responded.
	public func save(customData object: CustomUserDataValue?, forKey key: String, completion: NSError? -> Void) {
...
//MARK: - PREDEFINED DATA
	...
	/// - parameter data: The dictionary representing data you want to link with the current user.
	/// - parameter completion: The block to execute after the server responded.
	public func save(predefinedData predefinedData: [String: String], completion: NSError? -> Void) {
	...
	/// - parameter completion: The block to execute after the server responded.
	public func save(predefinedData object: String?, forKey key: MMUserPredefinedDataKeys, completion: NSError? -> Void) {
