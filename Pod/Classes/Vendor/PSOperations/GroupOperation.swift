...
class GroupOperation: Operation {
	...
	internal convenience init(operations: Foundation.Operation...) {
		self.init(operations: operations)
	}
	
	internal init(operations: [Foundation.Operation]) {
		super.init()
	...
	*/
	internal final func aggregateError(_ error: NSError) {
...
extension GroupOperation: OperationQueueDelegate {
	final internal func operationQueue(_ operationQueue: OperationQueue, willAddOperation operation: Foundation.Operation) {
	...
	final internal func operationQueue(_ operationQueue: OperationQueue, operationDidFinish operation: Foundation.Operation, withErrors errors: [NSError]) {
