...
class MessagingInfoManager : NSObject {
    ...
    private override init() {
        super.init()
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(MessagingInfoManager.handleRegistrationUpdatedNotification(_:)), name: MMEventNotifications.kRegistrationUpdated, object: nil)
    }
